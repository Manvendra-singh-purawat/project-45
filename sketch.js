...
function preload() {
  ...
  winimge=loadImage("OIP(2).jpg")
  ironmanimg=loadImage("OIP.jpg");
  spidermanimg=loadImage("OIP(3).jpg")
  hulkImg=loadImage("OIP(3).jpg")
  thorimg=loadImage("OIP(3).jpg")
  //captinamericaimg = loadImage("captin.png");
  //thanosimg=loadImage("Thanos.png");
  lazerimg=loadImage("OIP(3).jpg")
  playerimg = loadImage("OIP(3).jpg")

  looseimg=loadImage("OIP(2).jpg");
  
  shieldimg = loadImage("OIP(1).jpg");
}
function setup(){
  //canvas is created
